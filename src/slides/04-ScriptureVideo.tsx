    ...
    <Slide variant="scripture" className="relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex items-center justify-center gap-12">
        ...
        >
          ...
          <span className="text-gold-400/40 text-lg uppercase tracking-widest rotate-180" style={{ writingMode: 'vertical-rl' }}>
            The Word of God
          </span>
        </motion.div>
        ...
        <div className="text-center">
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <span className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-indigo-500/10 border border-indigo-400/30 text-indigo-300 text-xl font-semibold uppercase tracking-wider">
        ...
        <motion.div
          ...
          className="hidden lg:flex flex-col items-center gap-6 text-white/20"
        >
          <span className="text-gold-400/40 text-lg uppercase tracking-widest" style={{ writingMode: 'vertical-rl' }}>
            Colossians
          </span>
